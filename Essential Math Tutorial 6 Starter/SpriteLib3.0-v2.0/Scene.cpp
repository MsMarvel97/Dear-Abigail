...
int Scene::SpawnCrumblingPlatform(float xPos, float yPos, float width, float height, bool blue)
{
	int entity;
	{
		//Creates entity
		...
		if (blue)
		{
			fileName = "spritesheets/crumblingPlatformBlue.png";
		}
		else
		{
			fileName = "spritesheets/crumblingPlatform.png";
		}
